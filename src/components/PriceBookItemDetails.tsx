...
const PriceBookItemDetails: React.FC<PriceBookItemDetailsProps> = ({ isOpen, onClose, onSave, item, categories }) => {
                    ...
                    {activeTab === 'pricing' && (
                        <div className="space-y-6 animate-in slide-in-from-right-4 fade-in duration-200">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    <Label className="mb-1.5 text-muted-foreground text-xs uppercase font-bold tracking-wider">Unit Cost ($)</Label>
                                    <Input
                                        type="number"
                                        min="0"
                                        step="0.01"
