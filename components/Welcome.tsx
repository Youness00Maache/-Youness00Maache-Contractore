        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="flex justify-between items-center">
                ...
                <div className="hidden md:flex items-center gap-4">
                    ...
                    <Button onClick={onGetStarted} className="rounded-full px-6 py-2 text-sm font-semibold shadow-lg shadow-primary/20 hover:shadow-primary/40 transition-all">
                        Get Started
                    </Button>
                </div>
      ...
      <section className="relative pt-24 pb-10 lg:pt-36 lg:pb-20 overflow-hidden">
         ...
         <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 text-center">
             ...
             <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
                 <Button onClick={onGetStarted} size="lg" className="h-14 px-8 text-lg rounded-full shadow-xl shadow-blue-500/20 hover:shadow-blue-500/40 transition-all hover:-translate-y-1 bg-gradient-to-r from-blue-600 to-blue-700 border-0">
                    Start Building Free
