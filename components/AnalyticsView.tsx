        ...
        <div className="w-full bg-background text-foreground flex flex-col p-4 md:p-8 pb-24">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
                ...
                <Card className="lg:col-span-2 flex flex-col min-h-[320px] max-h-[400px] bg-card border-gray-400 dark:border-gray-600">
                    ...
                    <CardContent className="flex-1 flex flex-col overflow-x-auto scrollbar-thin scrollbar-thumb-muted-foreground/20 scrollbar-track-transparent">
                        <div className="flex-1 flex items-end justify-between gap-2 pt-4 pb-2 min-w-[600px] lg:min-w-0">
