  ...
  return (
    <div className="w-full h-full bg-background text-foreground flex flex-col">
       <header className="flex items-center p-4 border-b border-border">
        ...
        <h1 className="text-xl font-bold mx-auto">Select Document Type</h1>
        <div className="w-12"></div> {/* Spacer to keep title centered */}
      </header>
      
      <main className="flex-1 overflow-y-auto">
        <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-2 lg:grid-cols-4 relative z-10 border-t border-l border-border">
