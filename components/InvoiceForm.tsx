...
import { BackArrowIcon, ExportIcon, InvoiceIcon, ShareIcon, ClockIcon, TagIcon, SearchIcon, PercentIcon, SaveIcon } from './Icons.tsx';
...
const InvoiceForm: React.FC<InvoiceFormProps> = ({ job, userProfile, invoice, onSave, onClose, onUploadImage, savedItems = [], onSaveToPriceBook }) => {
