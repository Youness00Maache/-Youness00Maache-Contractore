  ...
  return (
    <div className="w-full h-full bg-background text-foreground flex flex-col p-4 md:p-8">
      ...
      <main className="flex-1 flex items-start justify-center overflow-y-auto">
        <Card className="w-full max-w-2xl animate-fade-in-down shadow-xl border-border/50">
          ...
          <CardContent className="space-y-6 pt-6">
            ...
            <div className="p-4 bg-secondary/20 rounded-xl border border-border/50 space-y-4">
                <h3 className="font-semibold text-sm text-muted-foreground uppercase tracking-wider">Client Information</h3>
          ...
          <CardFooter className="flex justify-end gap-3 bg-muted/20 border-t border-border p-6">
