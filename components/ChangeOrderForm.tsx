...
import { BackArrowIcon, ExportIcon, ChangeOrderIcon } from './Icons.tsx';
...
const ChangeOrderForm: React.FC<Props> = ({ job, profile, data, clients = [], onSave, onBack, onUploadImage }) => {
  ...
  const renderPageTwo = () => (
      <Card className="max-w-3xl mx-auto w-full animate-fade-in-down">
          ...
          <CardContent className="space-y-6">
              ...
              <div className="pt-4">
                  <Label className="mb-2 block">Client Approval Signature</Label>
  ...
  return (
    <div className="w-full h-full bg-background text-foreground flex flex-col p-4 md:p-8">
      <header className="grid grid-cols-3 items-center pb-4 border-b border-border mb-4">
        ...
        <h1 className="text-xl font-bold text-center flex items-center gap-2 justify-center"><ChangeOrderIcon className="w-5 h-5 text-primary" /> Change Order</h1>
